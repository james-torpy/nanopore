...
READS=$( ls $in_dir/*fastq | sort -h -t "." -k 2 | sed -n ${SGE_TASK_ID}p  )
T_READS=${READS##*/}
SUMMARY=/share/ScratchGeneral/jamfer/DM/lymph/seq_sum.txt.gz
INDEX=/share/ScratchGeneral/jamfer/DM/lymph/lymph.index.gz
THREADS=4
